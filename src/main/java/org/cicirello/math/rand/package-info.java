 ...
 *
 * <p>Copyright &copy; 2015, 2017-2022 <a href="https://www.cicirello.org/" target=_top>Vincent A. Cicirello</a>.</p> 
 *
 ...
 * alt="Maven Central" height="20" width="151"></a>
 * <a href="https://github.com/cicirello/ZigguratGaussian/releases"><img 
 * src="https://img.shields.io/github/v/release/cicirello/ZigguratGaussian?logo=GitHub" 
 * alt="GitHub release (latest by date)" height="20" width="111"></a>
 * <a href="https://github.com/cicirello/ZigguratGaussian"><img 
 * src="https://rho-mu.cicirello.org/images/GitHub.svg" 
 * alt="GitHub Repository" width="68" height="20"></a>
 * <a href="https://github.com/cicirello/ZigguratGaussian/blob/master/LICENSE"><img 
 * src="https://img.shields.io/github/license/cicirello/ZigguratGaussian" 
 ...
 *
 * <p>If you find the functionality of this package useful, please see 
 * the <a href="https://rho-mu.cicirello.org/">&rho;&mu; library</a>, which has <a href="https://rho-mu.cicirello.org/api/">absorbed this entire package
 * and has greatly expanded upon it</a>.</p>
 *
 * <h3>About</h3> 
 *
 * <p>This package originated as part of an effort to speed
 ...
 * Java API is the polar method (nextGaussian method of the {@link java.util.Random Random} and
 * {@link java.util.concurrent.ThreadLocalRandom ThreadLocalRandom} classes, however the polar method is quite slow
 ...
 * genetic algorithm (GA) using the implementation of the Ziggurat method for
