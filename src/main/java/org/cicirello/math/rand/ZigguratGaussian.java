 ...
 * using the Ziggurat Algorithm. The Ziggurat algorithm is significantly faster than the more
 * commonly encountered Polar method, and has some other desirable statistical properties. The
 * ZigguratGaussian class is a Java port of the GNU Scientific Library's C implementation (Voss,
 * 2005) of the Ziggurat method. In porting to Java, we have made a few subtle, and minor,
 * optimizations that are not worth specifying in the API documentation as they do not impact usage
 ...
 * </ul>
 *
 * <p>See the following articles for detailed description of the Ziggurat algorithm:
 *
 * <ul>
 *   <li>G. Marsaglia and W. W. Tsang. <a href=http://www.jstatsoft.org/v05/i08/ target=_top>The
 *       ziggurat method for generating random variables</a>. Journal of Statistical Software.
 *       5(1):1–7, 2000.
 *   <li>P. H. W. Leong, G. Zhang, D. Lee, W. Luk, and J. Villasenor. <a
 *       href=https://www.jstatsoft.org/article/view/v012i07 target=_top>A Comment on the
 *       Implementation of the Ziggurat Method</a>. Journal of Statistical Software. 12(7):1–4,
 *       2005.
